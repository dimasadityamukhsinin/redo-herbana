...
const termsConditions = () => {
  return (
    <section id={styles.assistance_wrappper}>
      <Head>
        <title>Terms & Condition - Herbana</title>
      </Head>
      <div>
        <NavAssistance active={"terms-conditions"} />
        <div id={styles.termsConditions}>
          <h1>Terms & Condition</h1>
          <div>
            <p>OVERVIEW</p>
            <p>&nbsp;</p>
            <p>
              This website is operated by Herbana. Throughout the site, the
              terms “we”, “us” and “our” refer to Herbana. Herbana offers this
            ...
            <p>
              ...
              governed by our Privacy Policy. View our Privacy Policy here.
            </p>
            <p>&nbsp;</p>
            ...
            <p>
              In no case shall Herbana, our directors, officers, employees,
            ...
            <p>&nbsp;</p>
            <p>
              You agree to indemnify, defend and hold harmless Herbana and our
            ...
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>SECTION 18 - CHANGES TO TERMS OF SERVICE</p>
            <p>&nbsp;</p>
            <p>
            ...
            <p>&nbsp;</p>
            <p>SECTION 19 - CONTACT INFORMATION</p>
            <p>&nbsp;</p>
            <p>
